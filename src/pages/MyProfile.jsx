...
const MyProfile = () => {
  const[userData,setUserData]=useState({
    ...
    address:{
      ...
      line2:"Circle, Church Road, Londom"
    },
    gender:'Male',
    dob:'2000-01-20'
  })
        ...
        <div className='mt-10'>
          {
            ...
            :<button className='border border-primary px-8 py-2 rounded-full  hover:text-white transition-all' onClick={()=>setEdit(true)}>Edit</button>
          }
        </div>
      </div>
    </div>
